    ...
    async signIn({ user, account }) {
      try {
        ...
        if (existing.rowCount === 0) {
          ...
          await pool.query(
            `INSERT INTO users (google_sub, email, name, profile_pic_url, pomo_length, short_length, long_length, session_target, work_day_start, work_day_end, timer_mode)
             VALUES ($1, $2, $3, $4, 25, 5, 15, 4, '00:00', '00:00', 'pomo')`,
